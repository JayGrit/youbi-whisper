...
WHISPER_SEMANTIC_SEGMENT_ENABLED = _env_bool("YDBI_WHISPER_SEMANTIC_SEGMENT_ENABLED", True)
WHISPER_SEMANTIC_SEGMENT_MIN_WORDS = int(os.environ.get("YDBI_WHISPER_SEMANTIC_SEGMENT_MIN_WORDS", "28"))
WHISPER_SEMANTIC_SEGMENT_EDITABLE_WORDS = int(os.environ.get("YDBI_WHISPER_SEMANTIC_SEGMENT_EDITABLE_WORDS", "180"))
WHISPER_SEMANTIC_SEGMENT_CONTEXT_WORDS = int(os.environ.get("YDBI_WHISPER_SEMANTIC_SEGMENT_CONTEXT_WORDS", "45"))
WHISPER_SEMANTIC_SEGMENT_TARGET_WORDS = int(os.environ.get("YDBI_WHISPER_SEMANTIC_SEGMENT_TARGET_WORDS", "12"))
WHISPER_SEMANTIC_SEGMENT_MAX_WORDS = int(os.environ.get("YDBI_WHISPER_SEMANTIC_SEGMENT_MAX_WORDS", "25"))
OPENAI_BASE_URL = os.environ.get("YDBI_OPENAI_BASE_URL", "https://open.bigmodel.cn/api/paas/v4")
OPENAI_MODEL = os.environ.get("YDBI_OPENAI_MODEL", "glm-4.5-air")
OPENAI_TIMEOUT_SECONDS = int(os.environ.get("YDBI_OPENAI_TIMEOUT_SECONDS", "120"))
